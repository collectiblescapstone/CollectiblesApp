        ...
        <Box bg="white" minH="100vh" color="black">
            ...
            <Flex flexDirection="column" alignItems="flex-start" gap={5} px={5}>
                ...
                <Field.Root required invalid={!!errors.username}>
                    ...
                    />
                    <Field.HelperText>
                        Your username must be unique and contain only letters,
            ...
            <Flex flexDirection="column" alignItems="flex-start" gap={2} px={5}>
                ...
                <Text fontSize="md" color="black" fontWeight="normal" mb={2}>
                    This is irreversible. Once you delete your account, your
                    account will be permanently removed from the online space.
                    All items in your collection will also be permanently
                    deleted.
                </Text>
            </Flex>
