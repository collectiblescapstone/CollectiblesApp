...
export const TestMetrics = () => {
  ...
  const updateMetrics = () => {
    ...
    setRecall(recall);
    setF1Score((2 * (precision * recall)) / (precision + recall + 0.000000001));
  };
                    ...
                    backgroundColor={
                      file.name
                        ...
                        ? cardId === 'NoCard'
                          ? 'green.500'
                          : 'red.500'
                        : cardId === file.name.split('.').slice(0, -1).join('.')
                          ? 'green.500'
                          : 'red.500'
                    }
                  >
                    <HStack>
                      ...
                      <VStack>
                        ...
                        <Text flex="1" textAlign="right" paddingRight="8">
                          {cardId}
                        </Text>
                      </VStack>
                    </HStack>
